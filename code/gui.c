...
void show_perf_table()
{
  ...
  if (switch_elevation_flag)
  {
    gtk_label_set_text(GTK_LABEL(r1_mean_elev), intToString(mean_d_norm_h));
    gtk_label_set_text(GTK_LABEL(r2_mean_elev), intToString(mean_d_norm_w));
    gtk_label_set_text(GTK_LABEL(r3_mean_elev), intToString(mean_d_norm_2));
    gtk_label_set_text(GTK_LABEL(r4_mean_elev), intToString(mean_d_norm_3));

    gtk_label_set_text(GTK_LABEL(r1_perc_elev), "Ref");
    gtk_label_set_text(GTK_LABEL(r2_perc_elev), intToString(perc_d_w));
    gtk_label_set_text(GTK_LABEL(r3_perc_elev), intToString(perc_d_2));
    gtk_label_set_text(GTK_LABEL(r4_perc_elev), intToString(perc_d_3));

    gtk_label_set_text(GTK_LABEL(r1_sd_elev), intToString(std_dev_d_h));
    gtk_label_set_text(GTK_LABEL(r2_sd_elev), intToString(std_dev_d_w));
    gtk_label_set_text(GTK_LABEL(r3_sd_elev), intToString(std_dev_d_2));
    gtk_label_set_text(GTK_LABEL(r4_sd_elev), intToString(std_dev_d_3));

    gtk_label_set_text(GTK_LABEL(r1_ratio_elev), floatToString(r1_elev_ratio));
    gtk_label_set_text(GTK_LABEL(r2_ratio_elev), floatToString(r2_elev_ratio));
    gtk_label_set_text(GTK_LABEL(r3_ratio_elev), floatToString(r3_elev_ratio));
    gtk_label_set_text(GTK_LABEL(r4_ratio_elev), floatToString(r4_elev_ratio));
  }
  else
  {

    gtk_label_set_text(GTK_LABEL(r1_area), floatToString(roi_area[0]));
    gtk_label_set_text(GTK_LABEL(r2_area), floatToString(roi_area[1]));
    gtk_label_set_text(GTK_LABEL(r3_area), floatToString(roi_area[2]));
    gtk_label_set_text(GTK_LABEL(r4_area), floatToString(roi_area[3]));

    gtk_label_set_text(GTK_LABEL(r1_mean), intToString(mean_d_norm_h));
    gtk_label_set_text(GTK_LABEL(r2_mean), intToString(mean_d_norm_w));
    gtk_label_set_text(GTK_LABEL(r3_mean), intToString(mean_d_norm_2));
    gtk_label_set_text(GTK_LABEL(r4_mean), intToString(mean_d_norm_3));

    gtk_label_set_text(GTK_LABEL(r1_perc), "Ref");
    gtk_label_set_text(GTK_LABEL(r2_perc), intToString(perc_d_w));
    gtk_label_set_text(GTK_LABEL(r3_perc), intToString(perc_d_2));
    gtk_label_set_text(GTK_LABEL(r4_perc), intToString(perc_d_3));

    gtk_label_set_text(GTK_LABEL(r1_sd), intToString(std_dev_d_h));
    gtk_label_set_text(GTK_LABEL(r2_sd), intToString(std_dev_d_w));
    gtk_label_set_text(GTK_LABEL(r3_sd), intToString(std_dev_d_2));
    gtk_label_set_text(GTK_LABEL(r4_sd), intToString(std_dev_d_3));
  }

  /*
    gtk_label_set_text(GTK_LABEL(r1_max), intToString(max_d_h));
    gtk_label_set_text(GTK_LABEL(r2_max), intToString(max_d_w));
    gtk_label_set_text(GTK_LABEL(r3_max), intToString(max_d_2));
    gtk_label_set_text(GTK_LABEL(r4_max), intToString(max_d_3));

    gtk_label_set_text(GTK_LABEL(r1_min), intToString(min_d_h));
    gtk_label_set_text(GTK_LABEL(r2_min), intToString(min_d_w));
    gtk_label_set_text(GTK_LABEL(r3_min), intToString(min_d_2));
    gtk_label_set_text(GTK_LABEL(r4_min), intToString(min_d_3));
  */
...
void show_porh_table()
{
  ...
  // gtk_label_set_text(GTK_LABEL(r1_area), intToString(mean_d_norm_h));
  // gtk_label_set_text(GTK_LABEL(r2_area), intToString(mean_d_norm_w));
  // gtk_label_set_text(GTK_LABEL(r3_area), intToString(mean_d_norm_2));
  // gtk_label_set_text(GTK_LABEL(r4_area), intToString(mean_d_norm_3));

  gtk_label_set_text(GTK_LABEL(r1_rf), intToString(pre_bas_lin_h));
  gtk_label_set_text(GTK_LABEL(r2_rf), intToString(pre_bas_lin_w));
  gtk_label_set_text(GTK_LABEL(r3_rf), intToString(pre_bas_lin_2));
  gtk_label_set_text(GTK_LABEL(r4_rf), intToString(pre_bas_lin_3));

  gtk_label_set_text(GTK_LABEL(r1_bz), intToString(min_d_h));
  gtk_label_set_text(GTK_LABEL(r2_bz), intToString(min_d_w));
  gtk_label_set_text(GTK_LABEL(r3_bz), intToString(min_d_2));
  gtk_label_set_text(GTK_LABEL(r4_bz), intToString(min_d_3));

  gtk_label_set_text(GTK_LABEL(r1_pf), intToString(max_d_h));
  gtk_label_set_text(GTK_LABEL(r2_pf), intToString(max_d_w));
  gtk_label_set_text(GTK_LABEL(r3_pf), intToString(max_d_2));
  gtk_label_set_text(GTK_LABEL(r4_pf), intToString(max_d_3));

  /*
    gtk_label_set_text(GTK_LABEL(r1_pobl), intToString(post_bas_lin_h));
    gtk_label_set_text(GTK_LABEL(r2_pobl), intToString(post_bas_lin_w));
    gtk_label_set_text(GTK_LABEL(r3_pobl), intToString(post_bas_lin_2));
    gtk_label_set_text(GTK_LABEL(r4_pobl), intToString(post_bas_lin_3));

    gtk_label_set_text(GTK_LABEL(r1_tm), floatToString(tm_h));
    gtk_label_set_text(GTK_LABEL(r2_tm), floatToString(tm_w));
    gtk_label_set_text(GTK_LABEL(r3_tm), floatToString(tm_2));
    gtk_label_set_text(GTK_LABEL(r4_tm), floatToString(tm_3));

    if (max_d_h < pre_bas_lin_h)
      gtk_label_set_text(GTK_LABEL(r1_th), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r1_th), floatToString(th_h));
    if (max_d_w < pre_bas_lin_w)
      gtk_label_set_text(GTK_LABEL(r2_th), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r2_th), floatToString(th_w));
    if (max_d_2 < pre_bas_lin_2)
      gtk_label_set_text(GTK_LABEL(r3_th), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r3_th), floatToString(th_2));
    if (max_d_3 < pre_bas_lin_3)
      gtk_label_set_text(GTK_LABEL(r4_th), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r4_th), floatToString(th_3));

    // gtk_label_set_text(GTK_LABEL(r1_tb), intToString(tb_h));
    // gtk_label_set_text(GTK_LABEL(r2_tb), intToString(tb_w));
    // gtk_label_set_text(GTK_LABEL(r3_tb), intToString(tb_2));
    // gtk_label_set_text(GTK_LABEL(r4_tb), intToString(tb_3));

    if (tb_h <= 0)
      gtk_label_set_text(GTK_LABEL(r1_tb), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r1_tb), floatToString(tb_h));
    if (tb_w <= 0)
      gtk_label_set_text(GTK_LABEL(r2_tb), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r2_tb), floatToString(tb_w));
    if (tb_2 <= 0)
      gtk_label_set_text(GTK_LABEL(r3_tb), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r3_tb), floatToString(tb_2));
    if (tb_3 <= 0)
      gtk_label_set_text(GTK_LABEL(r4_tb), " - ");
    else
      gtk_label_set_text(GTK_LABEL(r4_tb), floatToString(tb_3));
  */

  gtk_label_set_text(GTK_LABEL(r1_bz2pf), intToString(cal_percentage(min_d_h, max_d_h)));
  gtk_label_set_text(GTK_LABEL(r2_bz2pf), intToString(cal_percentage(min_d_w, max_d_w)));
  gtk_label_set_text(GTK_LABEL(r3_bz2pf), intToString(cal_percentage(min_d_2, max_d_2)));
  gtk_label_set_text(GTK_LABEL(r4_bz2pf), intToString(cal_percentage(min_d_3, max_d_3)));

  gtk_label_set_text(GTK_LABEL(r1_rf2bz), intToString(cal_percentage(pre_bas_lin_h, min_d_h)));
  gtk_label_set_text(GTK_LABEL(r2_rf2bz), intToString(cal_percentage(pre_bas_lin_w, min_d_w)));
  gtk_label_set_text(GTK_LABEL(r3_rf2bz), intToString(cal_percentage(pre_bas_lin_2, min_d_2)));
  gtk_label_set_text(GTK_LABEL(r4_rf2bz), intToString(cal_percentage(pre_bas_lin_3, min_d_3)));

  gtk_label_set_text(GTK_LABEL(r1_rf2pf), intToString(cal_percentage(pre_bas_lin_h, max_d_h)));
  gtk_label_set_text(GTK_LABEL(r2_rf2pf), intToString(cal_percentage(pre_bas_lin_w, max_d_w)));
  gtk_label_set_text(GTK_LABEL(r3_rf2pf), intToString(cal_percentage(pre_bas_lin_2, max_d_2)));
  gtk_label_set_text(GTK_LABEL(r4_rf2pf), intToString(cal_percentage(pre_bas_lin_3, max_d_3)));

  /*
    if (abs(min_d_h - pre_bas_lin_h) < 5)
    {
      gtk_label_set_text(GTK_LABEL(r1_tm), " - ");
      gtk_label_set_text(GTK_LABEL(r1_th), " - ");
      gtk_label_set_text(GTK_LABEL(r1_tb), " - ");
    }

    if (abs(min_d_w - pre_bas_lin_w) < 5)
    {
      gtk_label_set_text(GTK_LABEL(r2_tm), " - ");
      gtk_label_set_text(GTK_LABEL(r2_th), " - ");
      gtk_label_set_text(GTK_LABEL(r2_tb), " - ");
    }

    if (abs(min_d_2 - pre_bas_lin_2) < 5)
    {
      gtk_label_set_text(GTK_LABEL(r3_tm), " - ");
      gtk_label_set_text(GTK_LABEL(r3_th), " - ");
      gtk_label_set_text(GTK_LABEL(r3_tb), " - ");
    }

    if (abs(min_d_3 - pre_bas_lin_3) < 5)
    {
      gtk_label_set_text(GTK_LABEL(r4_tm), " - ");
      gtk_label_set_text(GTK_LABEL(r4_th), " - ");
      gtk_label_set_text(GTK_LABEL(r4_tb), " - ");
    }
  */
  g_print("PORH table calculated....\n");
  // gtk_style_context_remove_class(context, "highlighted");
}
